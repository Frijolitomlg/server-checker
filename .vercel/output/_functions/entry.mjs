...
var middlewareSecret = "7e1511e0-b1fe-416d-a5fd-2fc7dbe832a0";
//#endregion
...
var _page3 = () => import("./chunks/index_DZjcRbjX.mjs");
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "7e1511e0-b1fe-416d-a5fd-2fc7dbe832a0") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
