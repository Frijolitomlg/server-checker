...
import { A as clientAddressSymbol, C as isRoute404, D as DEFAULT_404_COMPONENT, E as ASTRO_GENERATOR, F as decryptString, I as generateCspDigest, M as originPathnameSymbol, N as responseSentSymbol$1, O as REDIRECT_STATUS_CODES, P as decodeKey, T as ASTRO_ERROR_HEADER, _ as pushDirective, a as chunkToString, c as renderSlotToString, g as normalizeCspResourceEntry, h as isRenderInstruction, i as renderComponent, j as fetchStateSymbol, k as REROUTABLE_STATUS_CODES, l as isRenderTemplateResult, n as renderPage, o as createSlotValueFromString, r as renderJSX, u as renderTemplate, v as isAstroComponentFactory, w as isRoute500, x as renderEndpoint, y as markHTMLString } from "./chunks/server_Klmzst-W.mjs";
...
var middlewareSecret = "e0a691f4-c88b-42a2-add1-3f08adb82b16";
//#endregion
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/api/status.ts",
			"pathname": "/api/status",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/web-status",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/web-status\\/?$",
			"segments": [[{
				"content": "api",
				"dynamic": false,
				"spread": false
			...
			"params": [],
			"component": "src/pages/api/web-status.ts",
			"pathname": "/api/web-status",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/servers.ts",
			"pathname": "/servers",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
...
var _page0 = () => import("./chunks/generic_mOucwbpA.mjs").then((n) => n.t);
var _page1 = () => import("./chunks/status_CYWKgV7a.mjs");
var _page2 = () => import("./chunks/web-status_C3CqKCD_.mjs");
var _page3 = () => import("./chunks/servers_rf0c1r2g.mjs");
var _page4 = () => import("./chunks/index_f_znA4eF.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/api/status.ts", _page1],
	["src/pages/api/web-status.ts", _page2],
	["src/pages/servers.ts", _page3],
	["src/pages/index.astro", _page4]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///D:/Development/server-checker/","cacheDir":"file:///D:/Development/server-checker/node_modules/.astro/","outDir":"file:///D:/Development/server-checker/dist/","srcDir":"file:///D:/Development/server-checker/src/","publicDir":"file:///D:/Development/server-checker/public/","buildClientDir":"file:///D:/Development/server-checker/dist/client/","buildServerDir":"file:///D:/Development/server-checker/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/status","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/status\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"status","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/status.ts","pathname":"/api/status","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/web-status","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/web-status\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"web-status","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/web-status.ts","pathname":"/api/web-status","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/servers","isIndex":false,"type":"endpoint","pattern":"^\\/servers\\/?$","segments":[[{"content":"servers","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/servers.ts","pathname":"/servers","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":"html,body{background:#0b1424;width:100%;height:100%;margin:0}*{box-sizing:border-box}body{color:#fff;background:#171717;font-family:Inter,Segoe UI,sans-serif}.page-shell[data-astro-cid-lcdefpme]{background:#171717;flex-direction:column;align-items:center;gap:128px;min-height:100vh;padding:112px 48px 40px;display:flex;overflow:hidden}.page-title[data-astro-cid-lcdefpme]{text-align:center;padding:10px}h1[data-astro-cid-lcdefpme]{margin:0;font-family:Cal Sans,Inter,sans-serif;font-size:clamp(2.5rem,5vw,3.75rem);font-weight:400;line-height:1.1}.server-grid[data-astro-cid-lcdefpme]{justify-content:center;align-items:flex-start;gap:80px;width:min(100%,976px);display:flex}.service-links[data-astro-cid-lcdefpme]{width:min(100%,976px)}.service-row[data-astro-cid-lcdefpme]{justify-content:center;align-items:center;gap:12px;font-size:1.25rem;display:flex}.service-row[data-astro-cid-lcdefpme] a[data-astro-cid-lcdefpme]{color:#fff}.service-indicator[data-astro-cid-lcdefpme]{background:#737373;border-radius:50%;width:14px;height:14px}.service-indicator[data-astro-cid-lcdefpme].online{background:#a3e635}.service-indicator[data-astro-cid-lcdefpme].offline{background:#b91c1c}.server-card[data-astro-cid-lcdefpme]{flex-direction:column;align-items:stretch;gap:14px;width:288px;display:flex}.server-card[data-astro-cid-lcdefpme] h2[data-astro-cid-lcdefpme]{text-align:center;min-height:54px;margin:0;padding:10px;font-size:1.75rem;font-weight:400;line-height:1.15}.server-card[data-astro-cid-lcdefpme] img[data-astro-cid-lcdefpme]{aspect-ratio:1;object-fit:cover;border:2px solid #a3e635;border-radius:24px;width:100%}.server-card[data-astro-cid-lcdefpme].offline img[data-astro-cid-lcdefpme]{border-color:#b91c1c}.detail-row[data-astro-cid-lcdefpme]{justify-content:space-between;align-items:center;gap:16px;padding:0 20px;font-size:1.875rem;line-height:1.2;display:flex}.detail-row[data-astro-cid-lcdefpme] strong[data-astro-cid-lcdefpme]{font-weight:700}.server-version[data-astro-cid-lcdefpme]{font-size:16px}.server-status[data-astro-cid-lcdefpme]{color:#a3e635}.server-card[data-astro-cid-lcdefpme].offline .server-status[data-astro-cid-lcdefpme]{color:#b91c1c}.server-output[data-astro-cid-lcdefpme]{display:none}footer[data-astro-cid-lcdefpme]{align-items:center;gap:6px;width:224px;padding:10px;font-size:.75rem;display:flex}footer[data-astro-cid-lcdefpme] img[data-astro-cid-lcdefpme]{object-fit:cover;width:41px;height:43px}@media (width<=1100px){.page-shell[data-astro-cid-lcdefpme]{gap:88px;padding-left:24px;padding-right:24px}.server-grid[data-astro-cid-lcdefpme]{gap:32px}}@media (width<=760px){.page-shell[data-astro-cid-lcdefpme]{gap:64px;padding:56px 16px 32px}.server-grid[data-astro-cid-lcdefpme]{flex-direction:column;align-items:center;gap:56px}.server-card[data-astro-cid-lcdefpme]{width:min(100%,288px)}}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["D:/Development/server-checker/src/pages/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_mOucwbpA.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_f_znA4eF.mjs","\u0000virtual:astro:page:src/pages/servers@_@ts":"chunks/servers_rf0c1r2g.mjs","D:/Development/server-checker/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_c2K-cSl_.mjs","\u0000virtual:astro:page:src/pages/api/status@_@ts":"chunks/status_CYWKgV7a.mjs","\u0000virtual:astro:page:src/pages/api/web-status@_@ts":"chunks/web-status_C3CqKCD_.mjs","D:/Development/server-checker/src/pages/index.astro?astro&type=script&index=0&lang.ts":"_astro/index.astro_astro_type_script_index_0_lang.T2D8wCoH.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[["D:/Development/server-checker/src/pages/index.astro?astro&type=script&index=0&lang.ts","var e=[{name:`Minecraft Vanilla`,online:!1,statusCode:0,output:``,version:`Unknown`},{name:`Minecraft Modded`,online:!1,statusCode:0,output:``,version:`Unknown`},{name:`Project Zomboid`,online:!1,statusCode:0,output:``,version:`Unknown`}];function t(e){for(let t of e){let e=document.querySelector(`[data-server-name=\"${t.name}\"]`),n=e?.querySelector(`.server-status`),r=e?.querySelector(`.server-version`),i=e?.querySelector(`.server-code`);e&&n&&r&&i&&(e.classList.toggle(`online`,t.online),e.classList.toggle(`offline`,!t.online),n.textContent=t.online?`Online`:`Offline`,r.textContent=t.version||`Unknown`,i.textContent=String(t.statusCode))}}async function n(){try{let e=await fetch(`/api/status`);if(!e.ok)throw Error(`Status request failed`);t(await e.json())}catch{t(e)}}async function r(){let e=document.querySelector(`[data-service-url]`)?.querySelector(`.service-indicator`);if(e)try{let t=await(await fetch(`/api/web-status`)).json();e.classList.toggle(`online`,t.online),e.classList.toggle(`offline`,!t.online),e.setAttribute(`aria-label`,t.online?`Online`:`Offline`)}catch{e.classList.add(`offline`),e.setAttribute(`aria-label`,`Offline`)}}n(),r(),setInterval(n,3e4),setInterval(r,3e4);"]],"assets":["/favicon.ico","/favicon.svg","/_astro/minecraft-modded.BhQtdWKh.png","/_astro/project-zomvoid.BbPjdpbm.png","/_astro/minecraft-vanilla.GqhUsyKn.png"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"aZoGZ626KdwGJ0jCHB0tIUgwwZGuVfPKSmA1nrtL3K0=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			OS: "Windows_NT",
			Path: "D:\\Development\\server-checker\\node_modules\\.bin;D:\\Development\\node_modules\\.bin;D:\\node_modules\\.bin;C:\\Program Files\\nodejs\\node_modules\\npm\\node_modules\\@npmcli\\run-script\\lib\\node-gyp-bin;c:\\Users\\kiaa0\\AppData\\Roaming\\Code\\User\\globalStorage\\github.copilot-chat\\debugCommand;c:\\Users\\kiaa0\\AppData\\Roaming\\Code\\User\\globalStorage\\github.copilot-chat\\copilotCli;C:\\Program Files\\Mozilla Firefox;C:\\WINDOWS\\system32;C:\\WINDOWS;C:\\WINDOWS\\System32\\Wbem;C:\\WINDOWS\\System32\\WindowsPowerShell\\v1.0\\;C:\\WINDOWS\\System32\\OpenSSH\\;C:\\Program Files\\NVIDIA Corporation\\NVIDIA App\\NvDLISR;C:\\Program Files (x86)\\NVIDIA Corporation\\PhysX\\Common;C:\\Program Files\\dotnet\\;C:\\Program Files\\nodejs\\;C:\\Program Files\\Docker\\Docker\\resources\\bin;C:\\Program Files\\Git\\cmd;C:\\Users\\kiaa0\\AppData\\Local\\Programs\\Python\\Python310\\Scripts\\;C:\\Users\\kiaa0\\AppData\\Local\\Programs\\Python\\Python310\\;C:\\Users\\kiaa0\\AppData\\Local\\Microsoft\\WindowsApps;C:\\Users\\kiaa0\\AppData\\Local\\Microsoft\\WinGet\\Links;C:\\Users\\kiaa0\\AppData\\Roaming\\npm;C:\\Users\\kiaa0\\AppData\\Local\\Programs\\Microsoft VS Code\\bin;C:\\Users\\kiaa0\\AppData\\Local\\cursor-agent"
		})?.PROD) return {
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "e0a691f4-c88b-42a2-add1-3f08adb82b16") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
