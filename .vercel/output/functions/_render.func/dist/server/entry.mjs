...
var middlewareSecret = "44b895ea-906e-43fb-82be-205f4d208183";
//#endregion
...
var _page4 = () => import("./chunks/index_B_CsyZeo.mjs");
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "44b895ea-906e-43fb-82be-205f4d208183") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
