...
var minecraft_modded_default = new Proxy({
	...
	if (name === "fsPath") return "D:/Development/legit-servers-status-check/src/assets/minecraft-modded.png";
	return target[name];
} });
//#endregion
...
var minecraft_vanilla_default = new Proxy({
	...
	if (name === "clone") return structuredClone(target);
	if (name === "fsPath") return "D:/Development/legit-servers-status-check/src/assets/minecraft-vanilla.png";
	return target[name];
} });
//#endregion
...
var project_zomvoid_default = new Proxy({
	...
	if (name === "clone") return structuredClone(target);
	if (name === "fsPath") return "D:/Development/legit-servers-status-check/src/assets/project-zomvoid.png";
	return target[name];
} });
//#endregion
